...
const PORTFOLIO_DATA = {
  personal: {
    name: "钟辉宇",
    title: "我正在寻找工作机会",
    subtitle: "精准农业 | 深度学习 | 嵌入式系统 | 机械设计 | 软件实现 | 电路设计" ,
    email: "zhonghuiyu01@gmail.com",
    phone: "13510210698",
    location: "广东深圳 / 北京",
    // 个人介绍：已根据最新要求修改和润色
    bio: `我是一名致力于设计和研发自动化农业设备的硕士研究生。
    
    我的工程之路始于本科期间对 SolidWorks 的热爱，在“大西瓜”创新团队中，我从一名结构设计成员成长为团队负责人，
    积累了扎实的机械设计功底。硕士期间，我转向智能化方向，主攻设备整机的研发，包括视觉、控制与结构设计。
    
    我具备独特的“软硬全栈”能力：
    • 硬件端：能独立完成除草系统的结构设计、设备选型、嵌入式通信（Arduino/Teensy）以及系统集成测试。
            拥有丰富的实地测试与硬件 Debug 经验，具备敏锐的排查思路和较强的动手解决能力，保障设备稳定运行。
    • 软件端：熟悉 Python 编程，深入理解并应用前沿深度学习模型：
      ...
      - ai应用：熟悉使用 Vibe Coding，能够熟练借助 AI 工具高效完成各项任务，提升工作效率。
    • 语言能力：英语口语流利，能够进行日常对话与技术交流，熟练阅读各类英文技术文档与前沿学术材料，具备扎实的英文专业报告与技术文档撰写能力。`,
    education: [
      {
        school: "中国农业大学",
        degree: "机械电子工程 (硕士 | 保研)",
        year: "2023.09 - 2026.06",
        desc: "研究方向：自动化农业设备的设计与研发 | 获一次一等奖学金，两次二等奖学金"
      },
      {
        school: "广东工业大学",
        degree: "机械电子工程 (学士 | 创新班)",
        year: "2019.09 - 2023.06",
        desc: "获两次一等奖学金，一次二等奖学金 | 英语六级 451 英语四级596"
      }
    ]
  },
  stats: [
